...
$id = (int) $_GET['id'];
$query_get = mysqli_query($koneksi, "SELECT * FROM jabatan WHERE id = $id");
$jabatan = mysqli_fetch_assoc($query_get);

if (!$jabatan) {
    echo "<script>alert('Data jabatan tidak ditemukan!'); window.location='index.php';</script>";
    exit;
}
...
if (isset($_POST['update'])) {
    ...
    $cek = mysqli_query($koneksi, "SELECT * FROM jabatan WHERE nama_jabatan = '$nama_jabatan' AND id != $id");
    if (mysqli_num_rows($cek) > 0) {
        $error = "Nama jabatan tersebut sudah digunakan oleh data lain!";
    } else {
...
<head>
    ...
    <title>Edit Jabatan - HRDash</title>
        ...
        <div id="page-content-wrapper" class="d-flex flex-column min-vh-100">
            ...
            <div class="container-fluid px-4 py-4 flex-grow-1">
                <div class="mb-4">
                    ...
                    <h4 class="m-0 fw-bold" style="color: #374151;">Edit Data Jabatan</h4>
                </div>
                            ...
                            <div class="card-body p-4">
                                ...
                                <form action="" method="POST">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="nama_jabatan" class="form-control form-control-custom" value="<?= htmlspecialchars($jabatan['nama_jabatan']); ?>" required autocomplete="off">
                                    </div>
